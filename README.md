<!-- mcp-name: io.github.CSOAI-ORG/translator-pro-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/translator-pro-ai-mcp.html)
...
[![PyPI](https://img.shields.io/pypi/v/translator-pro-ai-mcp)](https://pypi.org/project/translator-pro-ai-mcp/) [![Python](https://img.shields.io/pypi/pyversions/translator-pro-ai-mcp)](https://pypi.org/project/translator-pro-ai-mcp/)
...
```json
{
  "mcpServers": {
    "translator-pro-ai-mcp": {
      "command": "uvx",
      "args": ["translator-pro-ai-mcp"]
    }
  }
}
```

Or: `pip install translator-pro-ai-mcp` then run the `translator-pro-ai-mcp` command (stdio transport).
